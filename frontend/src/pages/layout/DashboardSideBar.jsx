...
const DashboardSideBar = ({ active }) => {
    return (
        <div className="w-[250px] h-[100vh] bg-pink-200 text-black shadow-md sticky top-0 left-0 z-10">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-orders" className="w-full flex items-center gap-2">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-products" className="w-full flex items-center gap-2">
                    <FaBox size={30}
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-create-product" className="w-full flex items-center gap-2">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-events" className="w-full flex items-center gap-2">
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-coupons" className="w-full flex items-center gap-2">
                    <AiOutlineGift
                        size={30}
            ...
            <div className="w-full flex items-center p-4">
                <Link to="/vendor/dashboard-refunds" className="w-full flex items-center gap-2">
